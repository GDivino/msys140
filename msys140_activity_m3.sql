-- ----------------------------------------------------- 
-- Data Management (sixth edition) by R.T. Watson
-- Schema msys40_activity
-- -----------------------------------------------------
DROP DATABASE IF EXISTS msys140_activity;
CREATE DATABASE  `msys140_activity`;
USE `msys140_activity`;


-- -----------------------------------------------------
-- Table `tblOffices` Activity
-- -----------------------------------------------------
...
CREATE TABLE `tblEmployees` (
  ...
  INDEX `fk_tblEmployees_tblEmployees_idx` (`reportsTo` ASC),
  INDEX `fk_tblEmployees_tblOffices_idx` (`officeCode` ASC),
  CONSTRAINT `fk_tblEmployees_tblEmployees`
    FOREIGN KEY (`reportsTo`)
    REFERENCES `tblEmployees` (`employeeNumber`),
  CONSTRAINT `fk_tblEmployees_tblOffices`
    FOREIGN KEY (`officeCode`)
    REFERENCES `tblOffices` (`officeCode`)
) ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `tblCustomers` Activity
-- -----------------------------------------------------
CREATE TABLE `tblCustomers` (
  ...
  INDEX `fk_tblCustomers_tblEmployees_idx` (`salesRepEmployeeNumber` ASC),
  CONSTRAINT `fk_tblCustomers_tblEmployees`
...
CREATE TABLE `tblProductLines` (
  ...
  PRIMARY KEY (`productLine`)) ENGINE = InnoDB;
...
CREATE TABLE `tblProducts` (
  ...
  INDEX `fk_tblProducts_tblProductLines_idx` (`productLine` ASC),
  CONSTRAINT `fk_tblProducts_tblProductLines`
    FOREIGN KEY (`productLine`)
    REFERENCES `tblProductLines` (`productLine`)) ENGINE = InnoDB;
...
CREATE TABLE `tblOrders` (
  ...
  INDEX `fk_tblOrders_tblCustomers_idx` (`customerNumber` ASC),
  CONSTRAINT `fk_tblOrders_tblCustomers`
    FOREIGN KEY (`customerNumber`)
    REFERENCES `tblCustomers` (`customerNumber`)) ENGINE = InnoDB;
...
CREATE TABLE `tblOrderDetails` (
  ...
  INDEX `fk_tblOrderDetails_tblProducts_idx` (`productCode` ASC),
  INDEX `fk_tblOrderDetails_tblOrders_idx` (`orderNumber` ASC),
  CONSTRAINT `fk_tblOrderDetails_tblProducts`
    FOREIGN KEY (`productCode`)
    REFERENCES `tblProducts` (`productCode`),
  CONSTRAINT `fk_tblOrderDetails_tblOrders`
    FOREIGN KEY (`orderNumber`)
    REFERENCES `tblOrders` (`orderNumber`))
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `tblOrderDetails` no index Activity
-- -----------------------------------------------------
CREATE TABLE `tblOrderDetails_no_index` (
  `orderNumber` INT(11) NOT NULL,
  `productCode` VARCHAR(15) NOT NULL,
  `quantityOrdered` INT(11) NOT NULL,
  `priceEach` DOUBLE NOT NULL,
...
CREATE TABLE `tblOrderDetails_memory` (
  `orderNumber` INT(11) NOT NULL,
  `productCode` VARCHAR(15) NOT NULL,
  `quantityOrdered` INT(11) NOT NULL,
  `priceEach` DOUBLE NOT NULL,
...
CREATE TABLE `tblPayments` (
  ...
  INDEX `fk_tblPayments_tblCustomers_idx` (`customerNumber` ASC),
  CONSTRAINT `fk_tblPayments_tblCustomers`
    FOREIGN KEY (`customerNumber`)
    REFERENCES `tblCustomers` (`customerNumber`))
ENGINE = InnoDB;
...
INSERT INTO `tblProductLines` (`productLine`,`textDescription`,`htmlDescription`,`image`) VALUES 
...
INSERT INTO tblProducts (`productCode`,`productName`,`productLine`,`product_Scale`,`productVendor`,`productDescription`,`quantityInStock`,`buyPrice`,`MSRP`) VALUES 
 ...
 ('S700_1938','The Mayflower','Ships','1:700','Studio M Art Models','Measures 31 1/2 inches Long x 25 1/2 inches High x 10 5/8 inches Wide r nAll wood with canvas sail. Extras include long boats, rigging, ladders, railing, anchors, side cannons, hand painted, etc.','737','43.3','86.61'),
 ...
 ('S700_2824','1982 Camaro Z28','Classic Cars','1:18','Carousel DieCast Legends','Features include opening and closing doors. Color: White.  r nMeasures approximately 9 1/2 inches Long.','6934','46.53','101.15'),
...
INSERT INTO tblOffices (`officeCode`,`city`,`phone`,`addressLine1`,`addressLine2`,`state`,`country`,`postalCode`,`territory`, `officeLocation`) VALUES ('1','San Francisco','+1 650 219 4782','100 Market Street','Suite 300','CA','USA','94080','NA', ST_GeomFromText('POINT(37.77493 -122.419416)', 4326)),
 ('2','Boston','+1 215 837 0825','1550 Court Place','Suite 102','MA','USA','02107','NA', ST_GeomFromText('POINT(42.358431 -71.059773)', 4326)),
 ('3','NYC','+1 212 555 3000','523 East 53rd Street','apt. 5A','NY','USA','10022','NA', ST_GeomFromText('POINT(40.714353 -74.005973)', 4326)),
 ('4','Paris','+33 14 723 4404','43 Rue Jouffroy D abbans',NULL,NULL,'France','75017','EMEA', ST_GeomFromText('POINT(48.856667 2.350987)', 4326)),
 ('5','Tokyo','+81 33 224 5000','4-1 Kioicho',NULL,'Chiyoda-Ku','Japan','102-8578','Japan', ST_GeomFromText('POINT(35.689488 139.691706)', 4326)),
 ('6','Sydney','+61 2 9264 2451','5-11 Wentworth Avenue','Floor #2','NSW','Australia','2010','APAC', ST_GeomFromText('POINT(-33.859972 151.211111)', 4326)),
 ('7','London','+44 20 7877 2041','25 Old Broad Street','Level 7',NULL,'UK','EC2N 1HN','EMEA', ST_GeomFromText('POINT(51.500152 -0.126236)', 4326));

# tblEmployees
# ------------------------------------------------------------

INSERT INTO tblEmployees (`employeeNumber`,`lastName`,`firstName`,`extension`,`email`,`officeCode`,`reportsTo`,`jobTitle`) VALUES ('1002','Murphy','Diane','x5800','dmurphy@classicmodelcars.com','1',NULL,'President'),
...
INSERT INTO tblOrders (`orderNumber`,`orderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`customerNumber`) VALUES ('10100','2003-01-06 00:00:00','2003-01-13 00:00:00','2003-01-10 00:00:00','Shipped',NULL,'363'),
 ...
 ('10165','2003-10-22 00:00:00','2003-10-31 00:00:00','2003-12-26 00:00:00','Shipped','This order was on hold because tblCustomers s credit limit had been exceeded. Order will ship when payment is received','148'),
 ...
 ('10173','2003-11-05 00:00:00','2003-11-15 00:00:00','2003-11-09 00:00:00','Shipped','Cautious optimism. We have happy tblCustomers here, if we can keep them well stocked.  I need all the information I can get on the planned shipments of Porches','278'),
 ...
 ('10260','2004-06-16 00:00:00','2004-06-22 00:00:00',NULL,'Cancelled','Customer heard complaints from their tblCustomers and called to cancel this order. Will notify the Sales Manager.','357'),
 ...
 ('10279','2004-08-09 00:00:00','2004-08-19 00:00:00','2004-08-15 00:00:00','Shipped','Cautious optimism. We have happy tblCustomers here, if we can keep them well stocked.  I need all the information I can get on the planned shipments of Porches','141'),
 ...
 ('10377','2005-02-09 00:00:00','2005-02-21 00:00:00','2005-02-12 00:00:00','Shipped','Cautious optimism. We have happy tblCustomers here, if we can keep them well stocked.  I need all the information I can get on the planned shipments of Porches','186'),
...
INSERT INTO tblOrderDetails (`orderNumber`,`productCode`,`quantityOrdered`,`priceEach`,`orderLineNumber`) VALUES ('10100','S18_1749','30','136','3'),
...
INSERT INTO tblPayments (`customerNumber`,`checkNumber`,`paymentDate`,`amount`) VALUES
